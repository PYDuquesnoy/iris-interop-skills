...
- `https://github.com/intersystems-ib/workshop-iris-dicom-interop` — DICOM interop workshop (local snapshot at `Documentacion/Mejores_Practicas/external/workshop-iris-dicom-interop/`).
