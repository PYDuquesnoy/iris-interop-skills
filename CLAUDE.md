...
- `Mejores_Practicas/` — the worked-example bank the skills cite:
  - `BestPractices_Ensemble_IRIS.md` — patterns tagged Validity/Severity.
...
- Skills reference the worked examples via `${CLAUDE_PLUGIN_ROOT}/Mejores_Practicas/…`
...
- Keep skills **self-sufficient**: a referenced example must travel inside this repo
  (under `Mejores_Practicas/`). No pointers to files outside the repo.
